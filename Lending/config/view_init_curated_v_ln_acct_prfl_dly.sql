...
select
	...
	due_amt as due_amt,
	due_dt as due_dt,
	dep_dedct_acct_no as dep_dedct_acct_no,
	ref_int_rate_dep_acct_no as ref_int_rate_dep_acct_no,
	...
	apprv_no as apprv_no,
	orig_adv_acct_no as orig_adv_acct_no,
	coa_acct as coa_acct,
	issu_br_no as issu_br_no,
	br_ownr_no as br_ownr_no,
	mkt_cd as mkt_cd,
