...
create table if not exists ${catalog}.curated_ln.ln_acct_prfl_dly (
	...
	cis_num string comment 'CIS Number',
	...
	lg_chnl string comment 'LG Channel',
	...
	bill_seq_num smallint comment 'Bill Sequence Number',
	...
	dep_dedct_acct_num string comment 'Deposit Deduct Account Number',
	ref_int_rate_dep_acct_num string comment 'Reference Interest Rate Deposit Account Number',
	...
	apprv_num string comment 'Approver Number',
	orig_adv_acct_num string comment 'Original Advancement Account Number',
	coa_acct string comment 'COA Account',
	issu_br_num string comment 'Issue Branch Number',
	br_ownr_num string comment 'Branch Owner Number',
