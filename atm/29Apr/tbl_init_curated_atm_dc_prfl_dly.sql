...
create table if not exists ${catalog}.curated_atm.atm_dc_prfl_dly (
	...
	mask_card_num string comment 'Masked Card Number',
	encpt_card_num string comment 'Encrypted Card Number',
	ordr_br_num string comment 'Order Branch Number',
	...
	svg_acct_num string comment 'Saving Account Number',
	svg_acct_actv_f string comment 'Saving Account Active Flag',
	crrnt_acct_num string comment 'Current Account Number',
	...
	last_tfr_amt float comment 'Last Transfer Amount',
	...
	pendg_annl_fee_amt float comment 'Pending Annual Fee Amount',
	entry_fee_amt float comment 'Entry Fee Amount',
	frst_yr_fee_amt float comment 'First-Year Fee Amount',
	annl_fee_amt float comment 'Annual Fee Amount',
	annl_fee_due_dt string comment 'Annual Fee Due Date',
	last_yr_fee_amt float comment 'Last Year Fee Amount',
	...
	rfund_amt float comment 'Refund Amount',
