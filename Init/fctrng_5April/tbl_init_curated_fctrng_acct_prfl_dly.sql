...
create table if not exists ${catalog}.curated_fctrng.fctrng_acct_prfl_dly (
	...
	last_int_rprc_dt decimal(9, 7) comment 'Last Interest Reprice Date',
	...
	ppymt_f string comment 'Prepayment Flag',
	ppymt_dt date comment 'Prepayment Date',
	ppymt_bal_orig_ccy decimal(18, 2) comment 'Prepayment Balance in Original Currency',
	ppymt_bal_thb decimal(18, 2) comment 'Prepayment Balance in THB',
	...
	int_day_past_due integer comment 'Interest Days Past Due',
	bot_day_past_due integer comment 'BOT Days Past Due',
