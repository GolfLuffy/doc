...
create table if not exists ${catalog}.curated_atm.atm_dc_prfl_dly (
	...
	masked_card_no string comment 'Masked Card Number',
	encrypted_card_no string comment 'Encrypted Card Number',
	...
	expire_dt string comment 'Expire Date',
	cncl_dt_tm timestamp comment 'Cancel Date Time',
	purge_f string comment 'Purge Flag',
	purge_dt date comment 'Purge Date',
	svg_acct_no string comment 'Saving Account Number',
	svg_acct_actv_f string comment 'Saving Account Active Flag',
	ca_no string comment 'Current Account Number',
	ca_actv_f string comment 'Current Account Active Flag',
	...
	nbr_of_prch_txn_per_day integer comment 'Number of Purchased Transaction Per Day',
	last_prch_dt date comment 'Last Purchase Date',
	cash_wdrw_amt decimal(13, 0) comment 'Cash Withdraw Amount',
	nbr_of_cash_wdrw integer comment 'Number of Cash Withdrawal',
	last_wdrw_dt date comment 'Last Withdrawal Date',
	link_acct_tfr_amt decimal(13, 0) comment 'Linkage Accounts Transferred Amount',
	nbr_of_link_acct_tfr integer comment 'Number of Linkage Accounts Transferred',
	intrabank_tfr_amt decimal(13, 0) comment 'Intrabank Transferred Amount',
	nbr_of_intrabank_tfr integer comment 'Number of Intrabank Transferred',
	onln_rtl_fund_tfr_amt decimal(13, 0) comment 'Online Retail Funds Transferred Amount',
	nbr_of_onln_rtl_fund_tfr integer comment 'Number of Online Retail Funds Transferred',
	...
	nbr_of_intrbnk_fee_mo integer comment 'Number of Interbank Fee Monthly',
	wdrw_fee_dt date comment 'Withdrawal Fee Date',
	nbr_of_wdrw_fee integer comment 'Number of Withdrawal Fee',
	t3ip_fee_dt date comment 'Third Party Fee Date',
	nbr_of_t3ip_fee integer comment 'Number of Third Party Fee',
	paymt_fee_dt date comment 'Payment Fee Date',
	nbr_of_paymt_fee integer comment 'Number of Payment Fee',
	pendg_annl_fee_dt date comment 'Pending Annual Fee Date',
	pendg_annl_fee_f string comment 'Pending Annual Fee Flag',
	nbr_of_pendg_annl_fee integer comment 'Number of Pending Annual Fee',
	pendg_fee decimal(19, 0) comment 'Pending Annual Fee Amount',
	entry_fee decimal(19, 0) comment 'Entry Fee Amount',
	frst_yr_fee decimal(19, 0) comment 'First-Year Fee Amount',
	annl_fee_amt decimal(19, 0) comment 'Annual Fee Amount',
	annl_fee_dt string comment 'Annual Fee Due Date',
	last_yr_fee decimal(19, 0) comment 'Last Year Fee Amount',
	last_yr_fee_dedct_dt date comment 'Last Year Fee Deducted Date',
	rfund_cd string comment 'Refund Code',
	rfund_dsc string comment 'Refund Description',
	rfnd_amt decimal(19, 0) comment 'Refund Amount',
	rfnd_dt date comment 'Refund Date',
	nbr_of_pin_err integer comment 'Number of PIN Error',
	pin_err_chnl string comment 'PIN Error Channel',
	nbr_of_reset_pin integer comment 'Number of Reset PIN',
